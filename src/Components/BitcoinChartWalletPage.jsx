  ...
  return (
    <div className="charts-container">
      ...
      <div  className="display> flex">
        ...
        <h1 className="charts-title text-lg sm:text-lg md:text-lg lg:text-xl xl:text-xl font-semibold text-white">BTC <span className="text-sm sm:text-sm md:text-sm lg:text-lg xl:text-lg text-white">Bitcoin Price</span></h1>
      </div>
      ...
      {currentPrice !== null && (
        <h2 className="currents-price text-2xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-3xl font-bold"> ${currentPrice.toLocaleString()}</h2>
      )}
...
export default BitcoinChartWalletPage;
