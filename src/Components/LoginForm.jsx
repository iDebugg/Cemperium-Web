    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="display: grid">
        ...
        <div className="text-right">
          <h5 className="forgotPasswordText text-sm sm:text-sm md:text-sm lg:text-sm xl:text-sm mt-2">
            Forgotten password?
          </h5>
        </div>
        <div className="text-center display: flex">
          <ToggleSwitch />
          <h4 className="forgotPasswordText text-sm sm:text-sm md:text-sm lg:text-sm xl:text-sm mt-1 ml-2">
            Remember me
          </h4>
        </div>
        ...
        <br />
        <button
          className="createAccountButton pt-2 pb-2 pr-10 pl-10 rounded-lg"
          type="submit"
          style={{
